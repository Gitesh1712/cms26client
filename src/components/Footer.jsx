...
<li>
                                <Link to="/About" className="text-slate-400 hover:text-orange-400 transition-colors flex items-center gap-2">
                                    About
                                </Link>
                            </li>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex flex-col gap-4">
                            <Link to="https://x.com/NoNoiseStories" target="_blank" rel="noopener noreferrer"
                                ...
                                <div className="w-9 h-9 rounded-full bg-slate-800 group-hover:bg-black border border-white/10 group-hover:border-white/30 flex items-center justify-center transition-all duration-200">
                            ...
                            <Link to="https://www.instagram.com/nonoisestories/" target="_blank" rel="noopener noreferrer"
                                className="flex items-center gap-3 text-slate-400 hover:text-white transition-all group">
                                <div className="w-9 h-9 rounded-full bg-slate-800 group-hover:bg-gradient-to-br group-hover:from-purple-600 group-hover:via-pink-500 group-hover:to-orange-400 border border-white/10 group-hover:border-transparent flex items-center justify-center transition-all duration-200">
                                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <Link to="https://www.linkedin.com/company/no-noise-stories/" target="_blank" rel="noopener noreferrer"
                                className="flex items-center gap-3 text-slate-400 hover:text-white transition-all group">
                                <div className="w-9 h-9 rounded-full bg-slate-800 group-hover:bg-[#0A66C2] border border-white/10 group-hover:border-transparent flex items-center justify-center transition-all duration-200">
                                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
